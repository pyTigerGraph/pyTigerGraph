...
setup(
  ...
  version = '0.0.9.7',      # Start with a small number and increase it with every change you make
  ...
  url = 'https://github.com/zrougamed/pyTigerGraph',   # Provide either the link to your github or to your website
